...
<a href="{{ route('items.show', ['item' => $item->item_name]) }}" class="inline-block">
        <div class="item__single !flex justify-center !flex-col w-2xs bg-gray-100 rounded-lg p-5 h-full hover:scale-120 hover:border-4 hover:border-white align-center gap-3 transition-transform duration-300">
